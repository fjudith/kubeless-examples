...
If run a [saltstack-kubernetes](https://github.com/fjudith/saltstack-kubernetes), make sure that [nats-operator](https://github.com/nats-io/nats-operator) is enabled in the pillar.
